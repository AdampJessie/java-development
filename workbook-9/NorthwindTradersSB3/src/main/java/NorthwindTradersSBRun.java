import com.pluralsight.NorthwindTradersSpringBoot3.NorthwindTradersSpringBoot3Application;
...
@Component
public class NorthwindTradersSBRun implements CommandLineRunner {
    ...
    private void addProduct(Scanner scanner, ProductService productService) {
    ...
    private void updateProduct(Scanner scanner, ProductService productService) {
    ...
    private void deleteProduct(Scanner scanner, ProductService productService) {
    ...
    private void searchProduct(Scanner scanner, ProductService productService) {
